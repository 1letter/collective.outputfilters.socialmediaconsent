...
Outputfilter for embedding social media plugins
...
Install collective.outputfilters.socialmediaconsent with `pip`:

```shell
pip install collective.outputfilters.socialmediaconsent
```
